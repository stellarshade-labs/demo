...
The `shade` command-line tool ships in the same repository. Prefer to run it yourself first? Clone the repo, deploy the pool contract to Stellar testnet, and walk a full send → scan → claim cycle:
